                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" 
                                                    ...
                                                    data-description="<%= t.getDescription() != null ? t.getDescription() : "" %>"
                                                    data-amount="<%= t.getAmount() %>"
                                                    data-type="<%= t.getType() %>"
                                                    data-category="<%= t.getCategory() != null ? t.getCategory() : "" %>"
          ...
          <form action="TransactionController" method="POST">
            ...
            <div class="modal-body">
              ...
              <div class="mb-3">
                ...
                <input type="date" class="form-control" id="editDate" name="transactionDate" required>
              </div>
            </div>
